    ...
    public static function meta($field = null, $search = false)
    {
        ...
        if ($field != null) {
            ...
            if ($field['e_type'] === 'DATEINTERVAL') {
                ...
                if (!$search) {
                    $aInterval = Field::newInstance()->getDateIntervalByPrimaryKey($field['fk_i_item_id'],
                        $field['pk_i_id']);
            ...
            if ($field['e_type'] === 'TEXTAREA') {
                if ($search) {
                    ...
                    $field_textarea_value = osc_apply_filter('osc_item_edit_meta_textarea_value_filter',
