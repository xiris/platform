...
class ItemForm extends Form
{
    ...
    public static function expiration_input($type = 'add', $value = '')
    {
        ...
        echo '<input id="dt_expiration" type="text" name="dt_expiration" value="' . osc_esc_html(htmlentities($value,
                ENT_COMPAT, 'UTF-8')) . '" placeholder="yyyy-mm-dd HH:mm:ss" />';
        return true;
    }
    ...
    public static function country_select($countries = null, $item = null)
    {
        ...
        if (count($countries) >= 1) {
            ...
            parent::generic_select('countryId', $countries, 'pk_c_code', 's_name', __('Select a country...'),
    ...
    public static function country_text($item = null)
    {
        ...
        parent::generic_input_text('countryName', isset($item['s_country']) ? $item['s_country'] : null, null,
            $only_one);
        parent::generic_input_hidden('countryId',
            (isset($item['fk_c_country_code']) && $item['fk_c_country_code'] != null) ? $item['fk_c_country_code'] : '');
        return true;
    }
    ...
    public static function region_select($regions = null, $item = null)
    {
        ...
        if (count($regions) >= 1) {
            ...
            parent::generic_select('regionId', $regions, 'pk_i_id', 's_name', __('Select a region...'),
    ...
    public static function region_text($item = null)
    {
        ...
        parent::generic_input_hidden('regionId',
            (isset($item['fk_i_region_id']) && $item['fk_i_region_id'] != null) ? $item['fk_i_region_id'] : '');
        return true;
    }
    ...
    public static function city_area_text($item = null)
    {
        ...
        parent::generic_input_hidden('cityAreaId',
            (isset($item['fk_i_city_area_id']) && $item['fk_i_city_area_id'] != null) ? $item['fk_i_city_area_id'] : '');
        return true;
    }
            ...
            $(document).ready(function () {
                ...
                $("form[name=item]").validate({
                    ...
                    messages: {
                        ...
                        <?php if(osc_images_enabled_at_items()) { ?>
                        "photos[]": {
                            accept: "<?php echo osc_esc_js(sprintf(__('Photo: must be %s'),
                ...
                <?php foreach ($resources as $_r) { ?>
                    <div id="<?php echo $_r['pk_i_id']; ?>" fkid="<?php echo $_r['fk_i_item_id']; ?>"
                        ...
                        <img src="<?php echo osc_apply_filter('resource_path',
                                osc_base_url() . $_r['s_path']) . $_r['pk_i_id'] . '_thumbnail.' . $_r['s_extension']; ?>"/><a
            ...
            <?php foreach ($resources as $_r) {
                ...
                <li class=" qq-upload-success">
                    ...
                    <div class="ajax_preview_img"><img src="<?php echo osc_apply_filter('resource_path',
                                osc_base_url() . $_r['s_path']) . $_r['pk_i_id'] . '_thumbnail.' . $_r['s_extension']; ?>"
            ...
            $(document).ready(function () {
                ...
                function canContinue(numUpload) {
                    ...
                    if (total <=<?php echo $maxImages;?>) {
                        ...
                        json.success = false;
                        $('#restricted-fine-uploader .qq-uploader').after($('<div class="alert alert-error"><?php echo osc_esc_js(sprintf(__('Too many items were uploaded. Item limit is %d.'),
                            $maxImages)); ?></div>'));
                    }
                    <?php } else { ?>
                    json.success = true;
